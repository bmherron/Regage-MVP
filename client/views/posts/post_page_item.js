...
Template[getTemplate('post_page_item')].created = function () {
  post = this.data;
};

Template[getTemplate('post_page_item')].helpers({
  avatarLink: function(){
...
Template[getTemplate('post_page_item')].events({
...
Template[getTemplate('post_page_item')].rendered = function(){
